...
INSERT INTO public.content_blocks (page_slug, section, key, content_type, label) VALUES
  ...
  ('home', 'ministry-youth',  'title',      'text',      'Amplified Youth Title'),
  ('home', 'ministry-youth',  'description','text',      'Amplified Youth Description'),
  ('home', 'ministry-youth',  'image_url',  'image_url', 'Amplified Youth Photo'),
  ...
  ('home', 'ministry-women',  'title',      'text',      'Cultivate Title'),
  ('home', 'ministry-women',  'description','text',      'Cultivate Description'),
